...
public class BasquetFragment extends Fragment {

    private BasquetViewModel basquetViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        basquetViewModel =
                ViewModelProviders.of(this).get(BasquetViewModel.class);
        ...
        databaseReference = database.getReference("chatBasquet");
